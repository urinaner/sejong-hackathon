...
public class ValleyService {
    ...
    public ValleyService(ValleyRepository valleyRepository){
        this.valleyRepository = valleyRepository;
    }

    public List<ValleyEntity> getValley(){
        return valleyRepository.findAll();
    }

    public List<ValleyEntity> findNearestValleys(double latitude, double longitude) {
        List<ValleyEntity> valleys = valleyRepository.findAll();
